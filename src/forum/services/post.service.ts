...
export class PostService {
  ...
  private getTextContext(): ChatCompletionMessageParam {
    return {
      role: 'system',
      content: `
                I am developing an application for space lovers with a forum. I will provide you with text from a post, 
                and your task is to categorize it as SPACE related or not:
               
                Please, return data in a format: {"allowPost": true or false (as boolean)} 
